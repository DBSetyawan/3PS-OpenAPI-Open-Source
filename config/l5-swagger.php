...
return [
    ...
    */
    'security' => [
        ...
        */
        'X-3PS-Authorization' => [ // Unique name of security
            'type' => 'apiKey', // The type of the security scheme. Valid values are "basic", "apiKey" or "oauth2".
            'description' => 'A short description for security scheme',
        ...
        //     'type' => 'apiKey', // The type of the security scheme. Valid values are "basic", "apiKey" or "oauth2".
        //     'description' => '3PS Application APIKey security.',
        //     'in' => 'header',
        //     'scheme' => 'http',
        //     'flows' => [
        //         "password" => [
    ...
    */
     ...
     */
    'constants' => [
        'L5_SWAGGER_CONST_HOST' => env('L5_SWAGGER_CONST_HOST', 'http://api.3permata.co.id/api/documentation'),
    ],
];
